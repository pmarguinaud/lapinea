...
USE YOE_AERODIAG, ONLY : NPAERODIAG, NPAERAOT, NPAERLISI_VAR, NPAERLISI_WVL, NPAERLISI, &
...
INTEGER(KIND=JPIM) :: IGRIBTC               ! GRIB code of Total Column (not AER)
INTEGER(KIND=JPIM) :: IGRIBSFC              ! GRIB code of Surface Flux 
INTEGER(KIND=JPIM) :: IGRIBDIAG(NPAERODIAG) ! GRIB codes of diagnostics (AER)
...
TYPE(TYPE_GFL_NAML)  :: YEXT_NL(JPGFL-JPNAMED_GFL-JPGHG-JPFORC-JPEZDIAG-JPAERO-JPERA40-&
 &                              JPNOGW-JPSLDIA-JPCH4S-JPAEROUT-NPAERAOT-NPAERLISI-&
 &                              JPUVP-JPCHEM-JPPHYS-JPCRM-JPLIMA) ! Extra fields
