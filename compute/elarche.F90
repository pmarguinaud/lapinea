...
REAL(KIND=JPRB) :: ZRR_TMP (KPROMA)
REAL(KIND=JPRB) :: ZYY_TMP (KPROMA)
REAL(KIND=JPRB) :: ZXX_TMP (KPROMA)

REAL(KIND=JPRB) :: ZLON_TMP (KPROMA)
REAL(KIND=JPRB) :: ZCOSLAT_TMP (KPROMA)
REAL(KIND=JPRB) :: ZSINLAT_TMP (KPROMA)
