...
CALL LARCINA(YDGEOMETRY,YDML_DYN,KST,KPROF,YDSL,IHVI,ISTALAT,LFINDVSEP,LSLHD,LSLHDQUAD,LLINTV,&
 ...
 & KIBL,&
 & PSCO,ZLEV,&
 & PB2(:,MSLB2KAPPA),PB2(:,MSLB2KAPPAT),PB2(:,MSLB2KAPPAM),PB2(:,MSLB2KAPPAH),&
 & PB2(:,MSLB2STDDISU),PB2(:,MSLB2STDDISV),PB2(:,MSLB2STDDISW),&
 & ZURL0,ZVRL0,ZWRL0,&
 & KVSEPC,KVSEPL,PCCO,&
...
IF (LNHDYN.AND.LGWADV.AND.(.NOT.LVFE_GW)) THEN
  ...
  CALL LARCINHA(YDGEOMETRY,YDML_DYN,KST,KPROF,YDSL,IHVI,ISTALAT,ITIP,IROT,ZLSDEPI,&
   & KIBL,&
   & PSCO,ZLEV,PB2(:,MSLB2KAPPA),PB2(:,MSLB2KAPPAT),PB2(:,MSLB2KAPPAM),PB2(:,MSLB2KAPPAH),&
   & PB2(:,MSLB2STDDISU),PB2(:,MSLB2STDDISV),PB2(:,MSLB2STDDISW),&
