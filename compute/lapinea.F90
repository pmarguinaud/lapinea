...
SUBROUTINE LAPINEA(&
 ...
 & KVSEPC,KVSEPL,&
 ! --- OUTPUT -----------------------------------------------------------------
 & PCCO,PUF,PVF,KL0,KLH0,PLSCAW,PRSCAW,KL0H,PLSCAWH,PRSCAWH,PSCO,PGFLT1)
...
REAL(KIND=JPRB) :: ZPROLEVDUM (YDGEOMETRY%YRDIM%NPROMA,YDGEOMETRY%YRDIMV%NFLEVG)
...
CALL LARCINA(YDGEOMETRY,YDML_DYN,KST,KPROF,YDSL,IHVI,ISTALAT,LFINDVSEP,LSLHD,LSLHDQUAD,LLINTV,&
 ...
 & KIBL,&
 & PSCO,ZLEV,&
 & PB2(:,MSLB2KAPPA :MSLB2KAPPA +NFLEVG-1),  &
 & PB2(:,MSLB2KAPPAT:MSLB2KAPPAT+NFLEVG-1),  &
 & PB2(:,MSLB2KAPPAM:MSLB2KAPPAM+NFLEVG-1),  &
 & PB2(:,MSLB2KAPPAH:MSLB2KAPPAH+NFLEVG-1),  &
 & PB2(:,MSLB2STDDISU:MSLB2STDDISU+NFLEVG-1),&
 & PB2(:,MSLB2STDDISV:MSLB2STDDISV+NFLEVG-1),&
 & PB2(:,MSLB2STDDISW:MSLB2STDDISW+NFLEVG-1),&
 & ZASLLEVDUM, ZASLLEVDUM, ZASLLEVDUM, &
 & KVSEPC,KVSEPL,PCCO,&
 & ZPROLEVDUM, ZPROLEVDUM, ZPROLEVDUM, ZPROLEVDUM, &
 & KL0,KLH0,ILEV,PLSCAW,PRSCAW,IDEP)
...
IF (LNHDYN.AND.LGWADV.AND.(.NOT.LVFE_GW)) THEN
  ...
  CALL LARCINHA(YDGEOMETRY,YDML_DYN,KST,KPROF,YDSL,IHVI,ISTALAT,ITIP,IROT,ZLSDEPI,&
   & KIBL,&
   & PSCO,ZLEV,PB2(:,MSLB2KAPPA:MSLB2KAPPA+NFLEVG-1),PB2(:,MSLB2KAPPAT:MSLB2KAPPAT+NFLEVG-1),&
   & PB2(:,MSLB2KAPPAM:MSLB2KAPPAM+NFLEVG-1),PB2(:,MSLB2KAPPAH:MSLB2KAPPAH+NFLEVG-1),&
   & PB2(:,MSLB2STDDISU:MSLB2STDDISU+NFLEVG-1),PB2(:,MSLB2STDDISV:MSLB2STDDISV+NFLEVG-1),&
   & PB2(:,MSLB2STDDISW:MSLB2STDDISW+NFLEVG-1),&
