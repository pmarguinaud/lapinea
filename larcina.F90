...
IF (LDPLANE) THEN
  ...
  IF (KROT == 1) THEN
    CALL ELARCHE(YDML_DYN,NPROMA,KST,KPROF,NFLEVG,YDSL,YDGEOMETRY%YREGSL,YDGEOMETRY%YREGEO,YDGSGEOM,PSCO,PCCO,ISTPT,KSTSZ,PSTACK)
  ENDIF
  ...
  CALL ELASCAW(&
   ...
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WCLA(1)),PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WCLASLD(1)),PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WCLASLT),&
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WCLAMAD(1)),&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLO),PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLOMAD),&
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WCLO(1)),PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WCLOSLD(1)),PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WCLOSLT),&
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WCLOMAD(1)),&
   & KL0,KLH0,KLEV,&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDVER),PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDVERMAD),PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WVINTW),&
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WVINTWSLD),PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WVINTWSLT),&
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WVINTWMAD),&
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WVINTWS),&
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WVDERW),PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WHVW),KDEP,ISTPT,KSTSZ,PSTACK)
...
IF (LDINTV) THEN
  CALL LAITLI(YDSL%NASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,NFLEN,&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLAT),PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLO+1),KL0(1,1,1),&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDVER),PURL0,PUF0,ISTPT,KSTSZ,PSTACK)
  CALL LAITLI(YDSL%NASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,NFLEN,&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLAT),PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLO+1),KL0(1,1,1),&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDVER),PVRL0,PVF0,ISTPT,KSTSZ,PSTACK)
  CALL LAITLI(YDSL%NASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,NFLEN,&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLAT),PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLO+1),KL0(1,1,1),&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDVER),PWRL0,PWF0,ISTPT,KSTSZ,PSTACK)
  IF(LSVTSM) THEN
    CALL ABOR1 ('UNEXPECTED CASE')
  ENDIF
ENDIF
