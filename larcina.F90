...
IF (LDPLANE) THEN
  ...
  IF (KROT == 1) THEN
    CALL ELARCHE(YDML_DYN,NPROMA,KST,KPROF,NFLEVG,YDSL,YDGEOMETRY%YREGSL,YDGEOMETRY%YREGEO,YDGSGEOM,PSCO,PCCO,KSTPT,KSTSZ,PSTACK)
  ENDIF
  ...
  CALL ELASCAW(&
   ...
   & PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WVDERW),PRSCAW(1,1,YDML_DYN%YYTRSCAW%M_WHVW),KDEP,KSTPT,KSTSZ,PSTACK)
...
IF (LDINTV) THEN
  CALL LAITLI(YDSL%NASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,NFLEN,&
   ...
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDVER),PURL0,PUF0,KSTPT,KSTSZ,PSTACK)
  CALL LAITLI(YDSL%NASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,NFLEN,&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLAT),PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLO+1),KL0(1,1,1),&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDVER),PVRL0,PVF0,KSTPT,KSTSZ,PSTACK)
  CALL LAITLI(YDSL%NASLB1,NPROMA,KST,KPROF,NFLEVG,NFLSA,NFLEN,&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLAT),PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDLO+1),KL0(1,1,1),&
   & PLSCAW(1,1,YDML_DYN%YYTLSCAW%M_WDVER),PWRL0,PWF0,KSTPT,KSTSZ,PSTACK)
  IF(LSVTSM) THEN
    CALL ABOR1 ('UNEXPECTED CASE')
  ENDIF
ENDIF
