...
elarche.intfb.ok: elarche.intfb.h model_dynamics_mod.o parkind1.o yomcst.o yemgeo.o yemgsl.o yomjfh.o yomgsgeom.o eint_mod.o stack_mod.o
	touch elarche.intfb.ok

elarmes.intfb.ok: elarmes.intfb.h model_dynamics_mod.o geometry_mod.o parkind1.o yomcst.o yomct0.o yomdyna.o yomlun.o yomrip.o eint_mod.o reduction.o stack_mod.o
	touch elarmes.intfb.ok

elascaw.intfb.ok: elascaw.intfb.h parkind1.o yomdyna.o yommp0.o eint_mod.o yomvsplip.o stack_mod.o
	touch elascaw.intfb.ok

laitli.intfb.ok: laitli.intfb.h parkind1.o stack_mod.o
	touch laitli.intfb.ok

lapinea.intfb.ok: lapinea.intfb.h model_dynamics_mod.o model_general_conf_mod.o geometry_mod.o parkind1.o yomct0.o yomdyna.o yomcver.o yomcst.o eint_mod.o stack_mod.o
	touch lapinea.intfb.ok

larcina.intfb.ok: larcina.intfb.h model_dynamics_mod.o geometry_mod.o parkind1.o yomcst.o yomdyna.o eint_mod.o stack_mod.o
	touch larcina.intfb.ok

larcinha.intfb.ok: larcinha.intfb.h model_dynamics_mod.o geometry_mod.o parkind1.o yomcst.o yomct0.o yomdyna.o yomlun.o eint_mod.o stack_mod.o
	touch larcinha.intfb.ok

lascaw_clo.intfb.ok: lascaw_clo.intfb.h parkind1.o yomdyna.o yomdyn.o stack_mod.o
	touch lascaw_clo.intfb.ok

lascaw_vintw.intfb.ok: lascaw_vintw.intfb.h parkind1.o yomdyna.o yomdyn.o eint_mod.o stack_mod.o
	touch lascaw_vintw.intfb.ok

create.ok: create.h
	touch create.ok
elascaw.func.ok: elascaw.func.h
	touch elascaw.func.ok
lascaw_clo.func.ok: lascaw_clo.func.h
	touch lascaw_clo.func.ok
...
pp_model_general_conf.body.ok: pp_model_general_conf.body.h
	touch pp_model_general_conf.body.ok
pp_model_general_conf.intf.ok: pp_model_general_conf.intf.h
	touch pp_model_general_conf.intf.ok
...
elarche.o: elarche.F90 model_dynamics_mod.o parkind1.o yomcst.o yemgeo.o yemgsl.o yomjfh.o yomgsgeom.o eint_mod.o stack_mod.o stack.ok abor1.intfb.ok
	$(FC) -c elarche.F90

elarmes.o: elarmes.F90 model_dynamics_mod.o geometry_mod.o parkind1.o yomcst.o yomct0.o yomdyna.o yomlun.o yomrip.o eint_mod.o reduction.o stack_mod.o stack.ok abor1.intfb.ok larcina.intfb.ok
	$(FC) -c elarmes.F90

elascaw.o: elascaw.F90 parkind1.o yomdyna.o yommp0.o eint_mod.o yomvsplip.o stack_mod.o stack.ok elascaw.func.ok lascaw_clo.intfb.ok lascaw_vintw.intfb.ok abor1.intfb.ok
	$(FC) -c elascaw.F90
...
laitli.o: laitli.F90 parkind1.o stack_mod.o stack.ok
	$(FC) -c laitli.F90

lapinea.o: lapinea.F90 model_dynamics_mod.o model_general_conf_mod.o geometry_mod.o parkind1.o yomct0.o yomdyna.o yomcver.o yomcst.o eint_mod.o stack_mod.o stack.ok elarmes.intfb.ok larcina.intfb.ok larcinha.intfb.ok abor1.intfb.ok
	$(FC) -c lapinea.F90

larcina.o: larcina.F90 model_dynamics_mod.o geometry_mod.o parkind1.o yomcst.o yomdyna.o eint_mod.o stack_mod.o stack.ok abor1.intfb.ok elarche.intfb.ok elascaw.intfb.ok laitli.intfb.ok
	$(FC) -c larcina.F90

larcinha.o: larcinha.F90 model_dynamics_mod.o geometry_mod.o parkind1.o yomcst.o yomct0.o yomdyna.o yomlun.o eint_mod.o stack_mod.o stack.ok abor1.intfb.ok elascaw.intfb.ok
	$(FC) -c larcinha.F90

lascaw_clo.o: lascaw_clo.F90 parkind1.o yomdyna.o yomdyn.o stack_mod.o stack.ok lascaw_clo.func.ok
	$(FC) -c lascaw_clo.F90

lascaw_vintw.o: lascaw_vintw.F90 parkind1.o yomdyna.o yomdyn.o eint_mod.o stack_mod.o stack.ok
...
reduction.o: reduction.F90 parkind1.o abor1.intfb.ok abor1.intfb.ok
	$(FC) -c reduction.F90
...
test_model_general_conf.o: test_model_general_conf.F90 load_model_general_conf_type_mod.o copy_model_general_conf_type_mod.o pp_model_general_conf.intf.ok pp_model_general_conf.intf.ok pp_model_general_conf.body.ok pp_model_general_conf.body.ok
	$(FC) -c test_model_general_conf.F90
...
wrap_lapinea.o: wrap_lapinea.F90 load_geometry_mod.o load_sl_struct_mod.o load_model_general_conf_type_mod.o load_model_dynamics_type_mod.o copy_geometry_mod.o copy_sl_struct_mod.o copy_model_general_conf_type_mod.o copy_model_dynamics_type_mod.o load_mod.o load_yomct0_mod.o load_yomdyna_mod.o load_yomcver_mod.o load_yomcst_mod.o load_yommp0_mod.o load_yomlun_mod.o load_yomjfh_mod.o xrd_getoptions.o parkind1.o stack_mod.o lapinea.intfb.ok abor1.intfb.ok
...
test_model_general_conf.x: test_model_general_conf.o abor1.o copy_geometry_mod.o copy_model_dynamics_type_mod.o copy_model_general_conf_type_mod.o copy_sl_struct_mod.o copy_tcco_mod.o copy_tcsgeom_mod.o copy_tcsgleg_mod.o copy_tdim_mod.o copy_tdimf_mod.o copy_tdimv_mod.o copy_tdyn_mod.o copy_tedim_mod.o copy_tedyn_mod.o copy_tegeo_mod.o copy_tegsl_mod.o copy_telbc_geo_mod.o copy_temmp_mod.o copy_tgem_mod.o copy_tgsgeom_mod.o copy_thslmer_mod.o copy_tlap_mod.o copy_tlep_mod.o copy_tlscaw_mod.o copy_tmp_mod.o copy_torog_mod.o copy_tptrgppc_mod.o copy_tptrslb15_mod.o copy_tptrslb1_mod.o copy_tptrslb2_mod.o copy_trip_mod.o copy_trscaw_mod.o copy_tsco_mod.o copy_tslrep_mod.o copy_tspgeom_mod.o copy_tspng_mod.o copy_tsta_mod.o copy_ttnh_mod.o copy_tvab_mod.o copy_tvertical_geom_mod.o copy_tveta_mod.o copy_tvfe_mod.o copy_tvsleta_mod.o copy_tvsplip_mod.o copy_type_aero_wvl_diag_mod.o copy_type_gfl_comp_mod.o copy_type_gfl_naml_mod.o copy_type_gfld_mod.o crmdims.o eint_mod.o elarche.o elarmes.o elascaw.o geometry_mod.o intdynsl_mod.o laitli.o lapinea.o larcina.o larcinha.o lascaw_clo.o lascaw_vintw.o load_geometry_mod.o load_mod.o load_model_dynamics_type_mod.o load_model_general_conf_type_mod.o load_sl_struct_mod.o load_tcco_mod.o load_tcsgeom_mod.o load_tcsgleg_mod.o load_tdim_mod.o load_tdimf_mod.o load_tdimv_mod.o load_tdyn_mod.o load_tedim_mod.o load_tedyn_mod.o load_tegeo_mod.o load_tegsl_mod.o load_telbc_geo_mod.o load_temmp_mod.o load_tgem_mod.o load_tgsgeom_mod.o load_thslmer_mod.o load_tlap_mod.o load_tlep_mod.o load_tlscaw_mod.o load_tmp_mod.o load_torog_mod.o load_tptrgppc_mod.o load_tptrslb15_mod.o load_tptrslb1_mod.o load_tptrslb2_mod.o load_trip_mod.o load_trscaw_mod.o load_tsco_mod.o load_tslrep_mod.o load_tspgeom_mod.o load_tspng_mod.o load_tsta_mod.o load_ttnh_mod.o load_tvab_mod.o load_tvertical_geom_mod.o load_tveta_mod.o load_tvfe_mod.o load_tvsleta_mod.o load_tvsplip_mod.o load_type_gfl_comp_mod.o load_type_gfl_naml_mod.o load_type_gfld_mod.o load_yomcst_mod.o load_yomct0_mod.o load_yomcver_mod.o load_yomdyna_mod.o load_yomjfh_mod.o load_yomlun_mod.o load_yommp0_mod.o model_dynamics_mod.o model_general_conf_mod.o par_gfl.o parkind1.o ptrgppc.o ptrslb1.o ptrslb15.o ptrslb2.o reduction.o spng_mod.o stack_mod.o type_geometry.o type_spgeom.o xrd_getoptions.o xrd_unix_env.o yemdim.o yemdyn.o yemgeo.o yemgsl.o yemlap.o yemlbc_geo.o yemmp.o yoe_aerodiag.o yom_ygfl.o yomcsgeom.o yomcst.o yomct0.o yomcver.o yomdim.o yomdimf.o yomdimv.o yomdyn.o yomdyna.o yomgem.o yomgsgeom.o yomhslmer.o yomjfh.o yomlap.o yomleg.o yomlun.o yomlun_ifsaux.o yommp.o yommp0.o yomorog.o yomrip.o yomslrep.o yomsta.o yomtnh.o yomvert.o yomvsleta.o yomvsplip.o
	$(FC) -o test_model_general_conf.x test_model_general_conf.o abor1.o copy_geometry_mod.o copy_model_dynamics_type_mod.o copy_model_general_conf_type_mod.o copy_sl_struct_mod.o copy_tcco_mod.o copy_tcsgeom_mod.o copy_tcsgleg_mod.o copy_tdim_mod.o copy_tdimf_mod.o copy_tdimv_mod.o copy_tdyn_mod.o copy_tedim_mod.o copy_tedyn_mod.o copy_tegeo_mod.o copy_tegsl_mod.o copy_telbc_geo_mod.o copy_temmp_mod.o copy_tgem_mod.o copy_tgsgeom_mod.o copy_thslmer_mod.o copy_tlap_mod.o copy_tlep_mod.o copy_tlscaw_mod.o copy_tmp_mod.o copy_torog_mod.o copy_tptrgppc_mod.o copy_tptrslb15_mod.o copy_tptrslb1_mod.o copy_tptrslb2_mod.o copy_trip_mod.o copy_trscaw_mod.o copy_tsco_mod.o copy_tslrep_mod.o copy_tspgeom_mod.o copy_tspng_mod.o copy_tsta_mod.o copy_ttnh_mod.o copy_tvab_mod.o copy_tvertical_geom_mod.o copy_tveta_mod.o copy_tvfe_mod.o copy_tvsleta_mod.o copy_tvsplip_mod.o copy_type_aero_wvl_diag_mod.o copy_type_gfl_comp_mod.o copy_type_gfl_naml_mod.o copy_type_gfld_mod.o crmdims.o eint_mod.o elarche.o elarmes.o elascaw.o geometry_mod.o intdynsl_mod.o laitli.o lapinea.o larcina.o larcinha.o lascaw_clo.o lascaw_vintw.o load_geometry_mod.o load_mod.o load_model_dynamics_type_mod.o load_model_general_conf_type_mod.o load_sl_struct_mod.o load_tcco_mod.o load_tcsgeom_mod.o load_tcsgleg_mod.o load_tdim_mod.o load_tdimf_mod.o load_tdimv_mod.o load_tdyn_mod.o load_tedim_mod.o load_tedyn_mod.o load_tegeo_mod.o load_tegsl_mod.o load_telbc_geo_mod.o load_temmp_mod.o load_tgem_mod.o load_tgsgeom_mod.o load_thslmer_mod.o load_tlap_mod.o load_tlep_mod.o load_tlscaw_mod.o load_tmp_mod.o load_torog_mod.o load_tptrgppc_mod.o load_tptrslb15_mod.o load_tptrslb1_mod.o load_tptrslb2_mod.o load_trip_mod.o load_trscaw_mod.o load_tsco_mod.o load_tslrep_mod.o load_tspgeom_mod.o load_tspng_mod.o load_tsta_mod.o load_ttnh_mod.o load_tvab_mod.o load_tvertical_geom_mod.o load_tveta_mod.o load_tvfe_mod.o load_tvsleta_mod.o load_tvsplip_mod.o load_type_gfl_comp_mod.o load_type_gfl_naml_mod.o load_type_gfld_mod.o load_yomcst_mod.o load_yomct0_mod.o load_yomcver_mod.o load_yomdyna_mod.o load_yomjfh_mod.o load_yomlun_mod.o load_yommp0_mod.o model_dynamics_mod.o model_general_conf_mod.o par_gfl.o parkind1.o ptrgppc.o ptrslb1.o ptrslb15.o ptrslb2.o reduction.o spng_mod.o stack_mod.o type_geometry.o type_spgeom.o xrd_getoptions.o xrd_unix_env.o yemdim.o yemdyn.o yemgeo.o yemgsl.o yemlap.o yemlbc_geo.o yemmp.o yoe_aerodiag.o yom_ygfl.o yomcsgeom.o yomcst.o yomct0.o yomcver.o yomdim.o yomdimf.o yomdimv.o yomdyn.o yomdyna.o yomgem.o yomgsgeom.o yomhslmer.o yomjfh.o yomlap.o yomleg.o yomlun.o yomlun_ifsaux.o yommp.o yommp0.o yomorog.o yomrip.o yomslrep.o yomsta.o yomtnh.o yomvert.o yomvsleta.o yomvsplip.o
...
subclean:
	\rm -f abor1.o elarche.o elarmes.o elascaw.o laitli.o lapinea.o larcina.o larcinha.o lascaw_clo.o lascaw_vintw.o test_geometry.o test_model_dynamics_type.o test_model_general_conf.o test_sl_struct.o wrap_lapinea.o
