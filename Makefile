...
subclean:
	\rm -f abor1.o elarche.o elarmes.o elascaw.o laitli.o lapinea.o larcina.o larcinha.o lascaw_clo.o lascaw_vintw.o test_geometry.o test_sl_struct.o wrap_lapinea.o
